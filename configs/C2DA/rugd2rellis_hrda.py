...
_base_ = [
    ...
    '../_base_/datasets/uda_rugdHR_to_rellisHR_338x338.py',
...
runner = dict(type='IterBasedRunner', max_iters=40005)
...
name = 'rugdHR2rellisHR_hrda_s1'
exp = 'basic'
name_dataset = 'rugdHR2rellisHR_338x338'
